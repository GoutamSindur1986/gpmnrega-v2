...
{
    public partial class getAgencyWageList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                System.DateTime year = System.DateTime.Parse(Request.QueryString["srch"]);
                ...
                string wagelistno = Request.QueryString["wageList"].Split('|')[0];
