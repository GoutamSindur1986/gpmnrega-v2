...
public class ProxyController : ControllerBase
{
    ...
    // ── POST /api/proxy/blknmrpdf ──────────────────────────────────
    // Accepts JSON { accdata: [...], meta: {...} }, builds HTML matching
    // blknmr1.aspx layout, converts via EvoPDF (A3 landscape), returns PDF.
    // Mirrors old flow: client POSTs JSON → blknmr1.aspx renders HTML → converter → PDF
    [HttpPost("blknmrpdf")]
    public IActionResult BlkNmrPdf([FromBody] BlkNmrRequest req)
    {
        try
        {
            if (req == null)
            ...
            var rows = req.Accdata ?? new List<BlkNmrRow>();
            var m    = req.Meta   ?? new BlkNmrMeta();
            int N    = Math.Max(1, m.Wkdays);
...
@font-face { font-family: tungab; src: url('/fonts/tungab.ttf'); font-weight: bold; }
body { font-family: Verdana, sans-serif; font-size: 10px; margin: 0; padding: 4px; }
table { border-collapse: collapse; width: 100%; }
td, th { border: 1px solid #111; padding: 2px 3px; font-size: 9px; }
.tunga { font-family: tunga, Verdana; }
...
.noborder td, .noborder th { border: none; }
            ...
            // ── Info row: State | NMR No | Print Date | District | Block | Panchayat | FinYear ──
            sb.Append("<table class='noborder' style='margin-bottom:2px'><tr>");
            sb.AppendFormat("<td class='left tunga'><b>ರಾಜ್ಯ :</b>&nbsp;{0}</td>", Encode(m.State));
            sb.AppendFormat("<td class='tunga'><b>ಮಸ್ಟರ್ ರೋಲ್ ಸಂಖ್ಯೆ</b> : {0}</td>", Encode(m.Msrno));
            sb.AppendFormat("<td><b>Muster Roll Printing date : </b>{0}</td>", today);
            sb.AppendFormat("<td class='tunga'><b>ಜಿಲ್ಲೆ:</b>{0}</td>", Encode(m.DistName));
            sb.AppendFormat("<td class='tunga'><b>ತಾಲ್ಲೂಕು:</b>{0}</td>", Encode(m.Block));
            sb.AppendFormat("<td class='tunga'><b>ಪಂಚಾಯತಿ:</b>{0}</td>", Encode(m.Panchayat));
            sb.AppendFormat("<td><b>Financial Year:</b>{0}</td>", Encode(m.FinYear));
            sb.Append("</tr></table>");

            // ── Work info rows ───────────────────────────────────────────
            sb.Append("<table class='noborder' style='margin-bottom:2px'><tr>");
            sb.AppendFormat("<td style='width:350px' class='tunga'><b>ಕಾಮಗಾರಿ ಸಂಕೇತ ಸಂಖ್ಯೆ : </b>{0}</td>", Encode(m.Workcode));
            sb.AppendFormat("<td class='tunga'><b>ಕಾಮಗಾರಿ ಹೆಸರು : </b>{0}</td>", Encode(m.Workname));
            sb.Append("</tr><tr>");
            sb.AppendFormat("<td class='tunga'><b>ದಿನಾಂಕದಿಂದ</b> :{0}&nbsp;&nbsp;&nbsp;<b>ದಿನಾಂಕದ ವರೆಗೆ</b> :{1}</td>", Encode(m.StartDate), Encode(m.EndDate));
            sb.AppendFormat("<td style='width:220px' class='tunga'><b>ಕಾರ್ಯನಿರ್ವಹಣಾ ಇಲಾಖೆ : </b>{0}</td>", Encode((m.Agency ?? "").Replace("(3)", "").Trim()));
            sb.AppendFormat("<td class='tunga'>&nbsp;<b>Technical sanction no &amp; Date</b> :{0}&nbsp;&nbsp;&nbsp;<b>Financial sanction no &amp; Date</b> :{1}</td>",
                Encode(m.TechSanNo + "(" + m.TechSanDate + ")"), Encode(m.FinSanNo + "(" + m.FinSanDate + ")"));
            sb.Append("</tr><tr>");
            sb.AppendFormat("<td colspan='3'><b>Name of technical staff responsible for measurement</b> : {0}</td>", Encode(m.TechStaff));
            sb.Append("</tr></table>");

            // ── Main muster roll table ───────────────────────────────────
            sb.Append("<table style='margin-bottom:2px'><thead>");
            // Header row 1
            sb.Append("<tr>");
            sb.Append("<th rowspan='2' width='2%' class='tunga center'><b>ಕ್ರ.ಸಂ</b></th>");
            sb.Append("<th rowspan='2' width='14%' class='tunga center'><b>ಹೆಸರು/ನೋಂದಣಿ ಸಂಖ್ಯೆ</b></th>");
            sb.Append("<th rowspan='2' width='10%' class='tunga center'><b>ಕುಟುಂಬದ ಮುಖ್ಯಸ್ಥರ ಹೆಸರು</b></th>");
            sb.Append("<th rowspan='2' width='10%' class='tunga center'><b>ಅರ್ಜಿದಾರರ ಹೆಸರು</b></th>");
            sb.Append("<th rowspan='2' width='10%' class='tunga center'><b>ಹಳ್ಳಿ</b></th>");
            sb.Append("<th rowspan='2' width='10%' class='tunga center'><b>ಖಾತೆ ಸಂಖ್ಯೆ</b></th>");
            sb.AppendFormat("<th colspan='{0}' width='14%' class='tunga center'><b>ದಿನವಹಿ ಹಾಜರಾತಿ</b></th>", N);
            sb.Append("<th rowspan='2' width='5%' class='tunga center'><b>ಒಟ್ಟು ಹಾಜರಾತಿ</b></th>");
            sb.Append("<th rowspan='2' width='5%' class='tunga center'><b>ಒಂದು ದಿನದ ವೇತನ</b></th>");
            sb.Append("<th rowspan='2' width='5%' class='tunga center'><b>ಹಾಜರಾತಿ ತಕ್ಕಂತೆ ಬಾಕಿ ಹಣ</b></th>");
            sb.Append("<th width='5%' class='tunga center'><b>ಪ್ರಯಾಣ ವೆಚ್ಚ</b></th>");
            sb.Append("<th rowspan='2' width='5%' class='center'><b>Implements / Sharpening Charge</b></th>");
            sb.Append("<th rowspan='2' width='10%' class='tunga center'><b>ಒಟ್ಟು ನಗದು ಪಾವತಿ</b></th>");
            sb.Append("<th rowspan='2' width='13%' class='tunga center'><b>ಅರ್ಜಿದಾರರ ಸಹಿ/ಹೆಬ್ಬೆಟ್ಟಿನ ಗುರುತು</b></th>");
            sb.Append("</tr>");
            // Header row 2: day numbers + Category
            sb.Append("<tr>");
            for (int d = 1; d <= N; d++)
                sb.AppendFormat("<th class='center'><b>{0}</b></th>", d);
            sb.Append("<th class='center'><b>Category</b></th>");
            ...
            {
                sb.Append("<tr>");
                sb.AppendFormat("<td class='center'>{0}</td>", Encode(row.SiNo?.ToString() ?? ""));
                sb.AppendFormat("<td class='left'>{0}</td>", Encode(row.JobCardNo ?? ""));
                sb.AppendFormat("<td class='tunga center'>{0}</td>", Encode(row.Hh ?? ""));
                sb.AppendFormat("<td class='tunga center'>{0}</td>", Encode(row.ApplicantName ?? ""));
                sb.AppendFormat("<td class='tunga center'>{0}</td>", Encode(row.Place ?? ""));
                sb.AppendFormat("<td>Bank<br/>{0}<br/>{1}</td>", Encode(row.Bkname ?? ""), Encode(row.Bkacc ?? ""));
                for (int d = 0; d < N; d++) sb.Append("<td>&nbsp;</td>");
                // 7 trailing cols — position 3 (0-based) = Category
                for (int t = 0; t < 7; t++)
                    sb.AppendFormat("<td class='center'>{0}</td>", t == 3 ? Encode(row.Category ?? "") : "&nbsp;");
                sb.Append("</tr>");
            }

            // Footer row
            sb.AppendFormat("<tr><td colspan='5' class='tunga left'><b>ಕಾಮಗಾರಿ ಆರಂಭ ದಿನಾಂಕ :</b></td><td class='tunga right'><b>ಒಟ್ಟು</b></td>");
            for (int d = 0; d < N; d++) sb.Append("<td>&nbsp;</td>");
            for (int t = 0; t < 7; t++) sb.Append("<td>&nbsp;</td>");
            sb.Append("</tr>");

            sb.Append("</tbody></table>");

            // ── Signature footer ─────────────────────────────────────────
            sb.Append("<table class='noborder' style='margin-top:10px'><tr>");
            sb.Append("<td width='50%' class='tunga center'>ಹಾಜರ ಪಡೆದವರ ಹೆಸರು (ಸಹಿ)</td>");
            sb.Append("<td width='50%' class='tunga center'>ಪರಿಶೀಲನೆ ಮಾಡಿದವರ ಸಹಿ</td>");
            sb.Append("</tr></table>");
            ...
            converter.LicenseKey = "aOb25/T05/Pz8PLn/+n35/T26fb16f7+/v7n9w==";
            converter.ConversionDelay = 0;
            converter.PdfDocumentOptions.LeftMargin  = 5;
            converter.PdfDocumentOptions.RightMargin = 5;
            converter.PdfDocumentOptions.TopMargin   = 5;
            converter.PdfDocumentOptions.PdfPageOrientation = EvoPdf.PdfPageOrientation.Landscape;

            bool isSubscribed = User.FindFirst("IsSubscribed")?.Value == "true";
            if (!isSubscribed)
                converter.BeforeRenderPdfPageEvent += ConverterWatermark;

            string baseUrl = $"{Request.Scheme}://{Request.Host}/";
            byte[] pdfBytes = converter.ConvertHtml(html, baseUrl);

            var ts       = DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss");
            var filename = (m.Workcode ?? "blanknmr") + "_" + ts + "_blanknmr.pdf";
            Response.Headers["Content-Disposition"] = $"attachment; filename={filename}";
            return File(pdfBytes, "application/pdf");
        }
        catch (Exception ex)
        {
            _log.LogError(ex, "blknmrpdf failed");
            return StatusCode(500, new { error = "Blank NMR PDF generation failed: " + ex.Message });
        }
    }
...
// ── BlkNmr request models ──────────────────────────────────────────
public class BlkNmrRow
{
    [System.Text.Json.Serialization.JsonPropertyName("SiNo")]
    public int? SiNo { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("JobCardNo")]
    ...
    [System.Text.Json.Serialization.JsonPropertyName("bkname")]
    public string? Bkname { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("bkacc")]
    public string? Bkacc { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("category")]
    public string? Category { get; set; }
}

public class BlkNmrMeta
{
    [System.Text.Json.Serialization.JsonPropertyName("msrno")]
    public string? Msrno { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("startDate")]
    public string? StartDate { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("endDate")]
    public string? EndDate { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("wkdays")]
    public int Wkdays { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("finSanNo")]
    public string? FinSanNo { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("finSanDate")]
    public string? FinSanDate { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("techSanNo")]
    public string? TechSanNo { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("techSanDate")]
    public string? TechSanDate { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("panchayat")]
    public string? Panchayat { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("distName")]
    public string? DistName { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("state")]
    public string? State { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("block")]
    public string? Block { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("workname")]
    public string? Workname { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("workcode")]
    public string? Workcode { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("agency")]
    public string? Agency { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("techStaff")]
    public string? TechStaff { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("finYear")]
    public string? FinYear { get; set; }
}

public class BlkNmrRequest
{
    [System.Text.Json.Serialization.JsonPropertyName("accdata")]
    public List<BlkNmrRow>? Accdata { get; set; }
    [System.Text.Json.Serialization.JsonPropertyName("meta")]
    public BlkNmrMeta? Meta { get; set; }
}