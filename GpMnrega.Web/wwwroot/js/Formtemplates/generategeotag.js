function generategeotag(resp) {
    try {
        ...
        var docDefinition = {
            ...
            content: [
                ...
                },
                {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            width: '25%',
                            text: 'ತಾಲ್ಲೂಕು: ' + (resp.block || ''), fontSize: 10
                        },
                        {
                            // fixed width
                            width: '25%',
                            text: 'ಜಿಲ್ಲೆ: ' + (resp.dist || ''), fontSize: 10
                        },
                        {
                            // % width
                            width: '25%',
                ...
                },
                {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            // if there's more than one star-column, available width is divided equally
                            width: '40%',
                            text: 'Finanacial Year: ' + (resp.fin || ''), fontSize: 10,
                            bold: true
                        }
                    ]
                },
                    ...
                    columns: [
                        {
                            // auto-sized columns have their widths based on their content
                            width: '60%',
                            text: 'LAT: ' + (resp.lat || '') + ' LON: ' + (resp.lon || ''),
                            fontSize: 10,
                            bold: true
                        },
                        {
                            ...
                            // if there's more than one star-column, available width is divided equally
                            width: '40%',
                            text: 'Date Creation: ' + (resp.dateCreation || ''),
                            fontSize: 12,
                            bold: true
                        }
                    ]
                ...
                },
                {
                    ...
                    columns: [
                        {
                            image: (resp.stages && resp.stages[0] && resp.stages[0].img1) ? resp.stages[0].img1 : blnakImage,
                            width: 250,
                            height: 170
                        }, {
                        ...
                        {
                            image: (resp.stages && resp.stages[0] && resp.stages[0].img2) ? resp.stages[0].img2 : blnakImage,
                            width: 250,
                            height: 170
                        }
                    ]
                    ...
                    columns: [
                        {
                            ...
                            image: (resp.stages && resp.stages[1] && resp.stages[1].img1) ? resp.stages[1].img1 : blnakImage,
                            width: 250,
                            height: 170
                        }, {
                        ...
                        },
                        {
                            ...
                            image: (resp.stages && resp.stages[1] && resp.stages[1].img2) ? resp.stages[1].img2 : blnakImage,
                            width: 250,
                            height: 170
                        }
                    ]
                    ...
                    columns: [
                        {
                            ...
                            image: (resp.stages && resp.stages[2] && resp.stages[2].img1) ? resp.stages[2].img1 : blnakImage,
                            width: 250,
                            height: 170
                        }, {
                        ...
                        {
                            image: (resp.stages && resp.stages[2] && resp.stages[2].img2) ? resp.stages[2].img2 : blnakImage,
                            width: 250,
                            height: 170
                        }
                    ]
        ...
        if (window._gpAddWatermark === true)
